...
// Image
const anchitPhoto = toArrayBuffer(
  readFileSync(join(process.cwd(), "public/images/anchit.jpg"))
);
          ...
          <div tw="flex flex-row">
            ...
            <div tw="flex flex-col px-10 grow text-[28px] h-70 justify-center">
              ...
              <div tw="flex mb-5" style={font("Roboto Mono 400")}>
                <span tw="text-gray-400 mr-3">&mdash;</span> Software Engineer and Developer
              </div>
              <div tw="flex mb-5" style={font("Roboto Mono 400")}>
                <span tw="text-gray-400 mr-3">&mdash;</span> Passionate about Web Development
                and Open Source
              </div>
              <div tw="flex" style={font("Roboto Mono 400")}>
                <span tw="text-gray-400 mr-3">&mdash;</span> Sharing knowledge through writing
              </div>
            </div>
          </div>
        </main>
